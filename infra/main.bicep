...
module functionsApi './app/FunctionsApi.bicep' = {
  name: 'FunctionsApi'
  params: {
    name: '${abbrs.appContainerApps}functionsapi-${resourceToken}'
    location: location
    tags: tags
